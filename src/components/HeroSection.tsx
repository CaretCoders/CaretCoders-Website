...
import { BirdFlockCanvas } from './BirdFlockCanvas';
...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section id="hero" className="relative pt-16 pb-20 sm:pt-24 sm:pb-32 overflow-hidden bg-[#F5F5F7]">
      {/* Interactive Bird Flocking Murmuration Dots Animation */}
      <BirdFlockCanvas />
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          <div className="relative inline-block mx-auto max-w-full">
            ...
            <motion.div
              ...
              className="relative px-3.5 py-2.5 min-[380px]:px-5 min-[380px]:py-3.5 sm:px-10 sm:py-6 rounded-[1.5rem] sm:rounded-[2.75rem] backdrop-blur-2xl bg-white/55 border border-white/80 shadow-[0_20px_50px_rgba(0,0,0,0.04),inset_0_1px_2px_rgba(255,255,255,0.95)] overflow-hidden inline-flex items-center justify-center max-w-full whitespace-nowrap group"
            >
              ...
              {/* Large Confident Headline - Strictly Enforced Single Line */}
              <h1 className="text-[1.35rem] min-[360px]:text-[1.65rem] min-[420px]:text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-semibold tracking-[-0.04em] text-[#1D1D1F] leading-[1.04] relative z-10 select-none whitespace-nowrap">
