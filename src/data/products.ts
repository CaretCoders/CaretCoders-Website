...
export const productsData: Product[] = [
  ...
  },
  {
    ...
    shortDesc: 'Detail mint is an multi-platform management platform designed specifically for businesses operating across multiple locations—especially in the car detailing and automotive care industry. It simplifies day-to-day operations by streamlining employee management, material processing, and revenue tracking.',
    fullDesc: 'Detail mint is an multi-platform management platform designed specifically for businesses operating across multiple locations—especially in the car detailing and automotive care industry. It simplifies day-to-day operations by streamlining employee management, material processing, and revenue tracking across all branches.',
    highlights: [
